...
//        System.out.println(new URI(url));
    ...
    public void weatherDescriptionEndsWith(String description, String celsius) {
        ...
        String actualTempInCelsius = response.then().extract().path("tempInCelsius");
        System.out.println(actualWeatherDescription);
        assertEquals("The weather is " + description, actualWeatherDescription, "Temperature in celsius is: " + actualTempInCelsius);
